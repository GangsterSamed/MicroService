...
type GeoServiceClient interface {
	AddressSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*AddressResponse, error)
	GeoCode(ctx context.Context, in *GeoRequest, opts ...grpc.CallOption) (*AddressResponse, error)
}
...
func (c *geoServiceClient) AddressSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*AddressResponse, error) {
...
func (c *geoServiceClient) GeoCode(ctx context.Context, in *GeoRequest, opts ...grpc.CallOption) (*AddressResponse, error) {
	out := new(AddressResponse)
...
type GeoServiceServer interface {
	AddressSearch(context.Context, *SearchRequest) (*AddressResponse, error)
	GeoCode(context.Context, *GeoRequest) (*AddressResponse, error)
...
func (UnimplementedGeoServiceServer) AddressSearch(context.Context, *SearchRequest) (*AddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddressSearch not implemented")
}
func (UnimplementedGeoServiceServer) GeoCode(context.Context, *GeoRequest) (*AddressResponse, error) {
...
func _GeoService_GeoCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeoServiceServer).GeoCode(ctx, req.(*GeoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
